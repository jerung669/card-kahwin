...
// Set the countdown for September 16, 2024
var startTimeMillis = new Date().getTime(); // Current time in milliseconds
var endTimeMillis = new Date("2024-09-16T00:00:00Z").getTime(); // Target date in milliseconds

setupCountdown(".campaign-0", startTimeMillis, endTimeMillis);
 ...
 *  Add to Calendar
  ======================================================= */
const event = {
    title: "Jemputan Kenduri Kahwin Hayat & ekin",
    startDate: "20240916T033000Z", // YYYYMMDDTHHmmssZ (UTC)
    endDate: "20240916T000000Z",
    location: "LOT 233-A, KAMPUNG GONG TENGAH, BELAKANG TMN.SRI, 16100 KOTA BHARU, KELANTAN.",
...
function openGoogleMaps() {
    const latitude = 6.173344;  // Example latitude
    const longitude = 102.294502;  // Example longitude
    const googleMapsUrl = `https://www.google.com/maps/dir/?api=1&destination=${latitude},${longitude}&travelmode=driving`;

    console.log("Google Maps URL: ", googleMapsUrl); // Debugging output
    window.open(googleMapsUrl, "_blank");  // Open in a new tab
}

function openWaze() {
    const latitude = 6.173351;  // Example latitude
    const longitude = 102.294495;  // Example longitude
    //const wazeUrl = `https://waze.com/ul?ll=${latitude},${longitude}&navigate=yes`;
    const wazeUrl = `waze://?ll=${latitude},${longitude}&navigate=yes`

    console.log("Waze URL: ", wazeUrl); // Debugging output
